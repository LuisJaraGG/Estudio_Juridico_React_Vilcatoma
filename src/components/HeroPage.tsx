      ...
      >
        ...
        <div
          ...
          <img
            ...
            className="w-28 md:w-40 z-10"
          />
          <p className=" text-center text-white z-10   md:text-xl  mix-[400px]:text-xl mt-5 tracking-wider mb-3 titulo">
            <hr className="z-10 mx-10   flex   rounded-full  md:-mb-[1px] " />
